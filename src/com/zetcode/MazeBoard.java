...
public class MazeBoard extends JPanel implements ActionListener {
    ...
    private final int x1 = B_WIDTH/10;
    private final int x2 = B_WIDTH - x1;
    private final int y1 = B_HEIGHT/10;
    private final int y2 = B_HEIGHT - y1;
        ...
        if (inGame) {
            ...
            for (int z = 0; z < dots; z++) {
                if (z == 0) {
                    ...
                    g.setFont(small);
                    g.drawString("Score = " + msg, (B_WIDTH - metr.stringWidth(msg)) / 2, B_HEIGHT / 2);
   ...
   /* private void gameStarts(Graphics g){
    	...
    	String msg1 = "Please select which level you would like to play.";
